...
func scanTypeOptions() []string {
	return []string{"host_discovery", "service_detection", "os_probe", "combined", "arp_table", "snmp_inventory", "name_lookup", "dns_lookup", "lldp_cdp"}
}
...
func modeForType(scanType, mode string) (string, error) {
	switch scanType {
	case "arp_table", "snmp_inventory", "name_lookup", "dns_lookup", "lldp_cdp":
		return "standard_active", nil // SNMP/name/DNS lookups have no depth; any active mode runs them
	case "combined":
